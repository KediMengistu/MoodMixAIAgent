"""
Django settings for MoodMixDjangoProject project.
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        # Optional: Browsable API session login (will require CSRF for unsafe methods):
        # "rest_framework.authentication.SessionAuthentication",

        # Firebase auth for API clients:
